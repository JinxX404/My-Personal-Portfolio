  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-background dark:via-surface dark:to-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about my background, education, skills, and the values that drive my work as a software engineer."
        />
        <meta property="og:title" content="About Me — Moataz Mohammed" />
        <meta
          property="og:description"
          content="Learn about my background, education, skills, and values."
        />
      </Helmet>
      {/* Hero Section */}
          ...
          >
            <motion.div variants={itemVariants} className="text-center">
              ...
              <p className="text-lg text-secondary-600 max-w-2xl mx-auto">
                Key milestones, achievements, and growth moments that shaped my
                career path.
              </p>
            </motion.div>
                    ...
                    <div className="flex-shrink-0 relative">
                      <div
                        className={`w-16 h-16 rounded-full flex items-center justify-center border-4 transition-all duration-300 ${
                          item.type === "career"
                            ? "bg-accent border-accent-200"
                            : item.type === "certification"
                              ? "bg-cta border-cta-200"
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-800 to-accent-800 dark:from-primary-900 ">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              <Link
                to="/portfolio-gallery"
                className="bg-white text-primary-800 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                to="/contact-hub"
                className="bg-accent hover:bg-accent-600 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
              >
                <Icon name="MessageCircle" size={18} />
